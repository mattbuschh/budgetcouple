              ...
              <div className="space-y-4">
                      ...
                      {parametresPersonnes.personne1.photo ? (
                        <div className="relative">
                          <img
                            ...
                            alt={parametresPersonnes.personne1.nom}
                        ...
                        <div
                          className="w-12 sm:w-16 h-12 sm:h-16 rounded-full border-2 border-dashed border-gray-300 flex items-center justify-center"
                          style={{ backgroundColor: parametresPersonnes.personne1.couleur + '20' }}
                        >
                          <Camera className="w-4 sm:w-6 h-4 sm:h-6 text-gray-400" />
                        </div>
                      )}
                    </div>
                    <label className="cursor-pointer bg-blue-100 text-blue-700 px-2 sm:px-3 py-1 sm:py-2 rounded-lg hover:bg-blue-200 transition-colors text-sm sm:text-base">
                      <Camera size={14} className="inline mr-1 sm:mr-2 sm:w-4 sm:h-4" />
                      {parametresPersonnes.personne1.photo ? 'Changer' : 'Ajouter'}
                      <input
                        type="file"
                        accept="image/*"
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full h-8 sm:h-10 border border-gray-300 rounded-lg cursor-pointer"
                  />
                </div>
              </div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <div className="flex items-center space-x-3 sm:space-x-4">
                      ...
                      {parametresPersonnes.personne2.photo ? (
                        <div className="relative">
                          <img
                            ...
                            alt={parametresPersonnes.personne2.nom}
                            className="w-12 sm:w-16 h-12 sm:h-16 rounded-full object-cover border-2 border-gray-300"
                          />
                          <button
                        ...
                        <div
                          className="w-12 sm:w-16 h-12 sm:h-16 rounded-full border-2 border-dashed border-gray-300 flex items-center justify-center"
                          style={{ backgroundColor: parametresPersonnes.personne2.couleur + '20' }}
                        >
                          <Camera className="w-4 sm:w-6 h-4 sm:h-6 text-gray-400" />
                        </div>
                      )}
                    ...
                    <label className="cursor-pointer bg-blue-100 text-blue-700 px-2 sm:px-3 py-1 sm:py-2 rounded-lg hover:bg-blue-200 transition-colors text-sm sm:text-base">
                      <Camera size={14} className="inline mr-1 sm:mr-2 sm:w-4 sm:h-4" />
                      {parametresPersonnes.personne2.photo ? 'Changer' : 'Ajouter'}
                      <input
                        type="file"
                        accept="image/*"
          ...
          <div>
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 sm:gap-0 mb-4">
              ...
              <button
                ...
                className="flex items-center space-x-2 px-3 sm:px-4 py-2 bg-blue-100 text-blue-700 rounded-lg hover:bg-blue-200 transition-colors disabled:opacity-50 disabled:cursor-not-allowed text-sm sm:text-base"
              >
